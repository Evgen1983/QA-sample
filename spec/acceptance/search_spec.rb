...
feature 'Can search', %q{
  ...
  describe 'User can' do
    ...
    scenario 'search questions', type: :sphinx do
    ...
    scenario 'search answers', type: :sphinx do
    ...
    scenario 'search comments', type: :sphinx do
    ...
    scenario 'search users', type: :sphinx do
    ...
    scenario ' search nothing', type: :sphinx do
